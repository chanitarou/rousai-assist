...
労災申請アシストサイトでは自動保存機能があり、途中で保存して後から続きを入力できます。`,
    ...
    '必要書類': {
        keywords: ['必要', '書類', 'しょるい', '添付', '提出', 'ドキュメント'],
        answer: `<h4>申請に必要な書類</h4>

<strong>基本書類：</strong>
• 労災保険給付請求書（様式第8号、第16号の6など）
• 本人確認書類（運転免許証、マイナンバーカードなど）

<strong>医療関係書類：</strong>
• 医師の診断書
• 療養給付たる療養の給付請求書
• レントゲン写真（該当する場合）

<strong>事業主関係書類：</strong>
• 事業主の証明（災害発生状況の証明）
• 賃金台帳の写し

<strong>その他：</strong>
• 災害発生状況を証明できる資料（写真、第三者の証言など）
• 通勤経路図（通勤災害の場合）

<strong>アップロード方法：</strong>
申請画面のステップ5で、スマートフォンやカメラで撮影した書類をアップロードできます。`,
        relatedLinks: [
            { title: '申請の流れ', description: '申請手順を確認', icon: 'document' },
            { title: '給付の種類', description: '給付の詳細', icon: 'money' }
        ]
    },
    'サイト利用方法': {
        keywords: ['サイト', '使い方', '操作', '方法', 'やり方', 'ログイン', '画面'],
...
<strong>2. 申請の開始</strong>
• トップ画面から「新規申請」を選択
• 給付の種類を選んで申請を開始

<strong>3. 入力</strong>
• 10ステップの入力フォームで必要事項を入力
• 自動保存機能で途中保存が可能
• 住所検索など便利機能を活用

<strong>4. 回覧依頼</strong>
• 事業主や医療機関にメールで回覧依頼
• 各関係者が順次入力・証明
...
• 過去の申請履歴の閲覧`,
        relatedLinks: [
            { title: '申請の流れ', description: '詳しい手順', icon: 'document' }
        ]
    },
    '給付の種類': {
        keywords: ['給付', '種類', 'きゅうふ', '補償', '支給', '金額'],
        answer: `<h4>労災保険給付の種類</h4>

<strong>療養（補償）等給付：</strong>
• 労災病院や指定医療機関での治療費
• 無料で治療を受けられます

<strong>休業（補償）等給付：</strong>
• 働けない期間の所得補償
• 給付基礎日額の80%を支給（休業4日目から）

<strong>障害（補償）等給付：</strong>
• 障害が残った場合の補償
• 障害の程度に応じて年金または一時金

<strong>遺族（補償）等給付：</strong>
• 労働者が死亡した場合の遺族への給付
• 年金または一時金

<strong>葬祭料（葬祭給付）：</strong>
• 葬祭を行う場合の費用

<strong>傷病（補償）等年金：</strong>
• 療養開始後1年6ヶ月経過後も治らない場合

<strong>介護（補償）等給付：</strong>
• 介護が必要な重度障害者への給付`,
        relatedLinks: [
            { title: '申請の流れ', description: '給付の申請方法', icon: 'document' }
        ]
    },
    '通勤災害': {
        keywords: ['通勤', '通勤災害', 'つうきん', '通勤途中', '帰宅'],
        answer: `<h4>通勤災害について</h4>

<strong>通勤災害とは：</strong>
通勤途中の災害で、以下の経路での負傷・疾病・障害・死亡を指します。

<strong>対象となる通勤：</strong>
• 住居と就業場所との往復
• 就業場所から他の就業場所への移動
• 単身赴任先住居と帰省先住居との移動

<strong>認められる条件：</strong>
• 合理的な経路と方法での移動
• 業務の性質を有する移動
• 移動が中断・逸脱していない
...
<strong>申請様式：</strong>
通勤災害の場合は「様式第16号の6」を使用します。`,
        relatedLinks: [
            { title: '申請の流れ', description: '通勤災害の申請', icon: 'document' },
            { title: '必要書類', description: '通勤経路図など', icon: 'document' }
        ]
    },
    'FAQ': {
        keywords: ['よくある', '質問', 'FAQ', 'faq', '疑問', 'わからない'],
        answer: `<h4>よくある質問（FAQ）</h4>

<strong>Q1: パートやアルバイトでも労災保険は使えますか？</strong>
A: はい、雇用形態に関わらず、労働者であれば対象となります。

<strong>Q2: 申請期限はありますか？</strong>
A: 給付の種類によって異なりますが、療養補償給付は時効5年です。早めの申請をお勧めします。

<strong>Q3: 事業主が協力してくれない場合は？</strong>
A: 事業主の証明がなくても申請は可能です。労働基準監督署に相談してください。

<strong>Q4: 給付はいつ振り込まれますか？</strong>
A: 審査完了後、通常2週間〜1ヶ月程度で指定口座に振り込まれます。

<strong>Q5: 申請中でも病院に通えますか？</strong>
A: はい、労災指定医療機関であれば無料で治療を受けられます。

<strong>Q6: 休業補償はいつからもらえますか？</strong>
A: 休業4日目から支給対象となります（最初の3日間は事業主が補償）。`,
        relatedLinks: [
            { title: '労災保険とは', description: '制度の詳細', icon: 'document' },
            { title: 'サイトの使い方', description: '操作方法', icon: 'help' }
        ]
    }
};
